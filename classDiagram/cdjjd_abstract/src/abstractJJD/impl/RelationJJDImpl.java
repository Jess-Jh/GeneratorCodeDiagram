 ...
 * </p>
 * <ul>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getRolA <em>Rol A</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getRolB <em>Rol B</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getNavigabilityA <em>Navigability A</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getNavigabilityB <em>Navigability B</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getMultiplicityA <em>Multiplicity A</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getMultiplicityB <em>Multiplicity B</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getSource <em>Source</em>}</li>
 *   <li>{@link abstractJJD.impl.RelationJJDImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationJJDImpl extends EObjectImpl implements RelationJJD {
	...
	protected EClass eStaticClass() {
		return AbstractJJDPackage.Literals.RELATION_JJD;
	}
	...
	public void setRolA(String newRolA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__ROL_A, oldRolA, rolA));
	}
	...
	public void setRolB(String newRolB) {
		...
		rolB = newRolB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__ROL_B, oldRolB, rolB));
	}
	...
	public void setNavigabilityA(String newNavigabilityA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__NAVIGABILITY_A, oldNavigabilityA, navigabilityA));
	}
	...
	public void setNavigabilityB(String newNavigabilityB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__NAVIGABILITY_B, oldNavigabilityB, navigabilityB));
	}
	...
	public void setMultiplicityA(String newMultiplicityA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__MULTIPLICITY_A, oldMultiplicityA, multiplicityA));
	}
	...
	public void setMultiplicityB(String newMultiplicityB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__MULTIPLICITY_B, oldMultiplicityB, multiplicityB));
	}
	...
	public ClassJJD getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractJJDPackage.RELATION_JJD__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ClassJJD newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__SOURCE, oldSource, source));
	}
	...
	public ClassJJD getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractJJDPackage.RELATION_JJD__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(ClassJJD newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractJJDPackage.RELATION_JJD__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractJJDPackage.RELATION_JJD__ROL_A:
				return getRolA();
			case AbstractJJDPackage.RELATION_JJD__ROL_B:
				return getRolB();
			case AbstractJJDPackage.RELATION_JJD__NAVIGABILITY_A:
				return getNavigabilityA();
			case AbstractJJDPackage.RELATION_JJD__NAVIGABILITY_B:
				return getNavigabilityB();
			case AbstractJJDPackage.RELATION_JJD__MULTIPLICITY_A:
				return getMultiplicityA();
			case AbstractJJDPackage.RELATION_JJD__MULTIPLICITY_B:
				return getMultiplicityB();
			case AbstractJJDPackage.RELATION_JJD__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case AbstractJJDPackage.RELATION_JJD__TARGET:
