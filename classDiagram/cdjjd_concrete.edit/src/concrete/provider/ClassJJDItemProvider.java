...
/**
 * This is the item provider adapter for a {@link concrete.ClassJJD} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassJJDItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretePackage.Literals.CLASS_JJD__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretePackage.Literals.CLASS_JJD__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConcretePackage.Literals.CLASS_JJD__IS_ABSTRACT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConcretePackage.Literals.CLASS_JJD__LIST_ATTRIBUTES_JJD);
			childrenFeatures.add(ConcretePackage.Literals.CLASS_JJD__LIST_METHODS_JJD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConcretePackage.Literals.CLASS_JJD__LIST_ATTRIBUTES_JJD,
				 ConcreteFactory.eINSTANCE.createAttributeJJD()));

		newChildDescriptors.add
			(createChildParameter
				(ConcretePackage.Literals.CLASS_JJD__LIST_METHODS_JJD,
				 ConcreteFactory.eINSTANCE.createMethodJJD()));
	}
