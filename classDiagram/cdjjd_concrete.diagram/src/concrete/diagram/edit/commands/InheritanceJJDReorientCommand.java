 ...
 * @generated
 */
public class InheritanceJJDReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InheritanceJJDReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof InheritanceJJD) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcreteBaseItemSemanticEditPolicy.getLinkConstraints().canExistInheritanceJJD_4002(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected InheritanceJJD getLink() {
		return (InheritanceJJD) getElementToEdit();
	}
