 ...
 * @generated
 */
public class ImplementJJDReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImplementJJDReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ImplementJJD) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcreteBaseItemSemanticEditPolicy.getLinkConstraints().canExistImplementJJD_4005(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected ImplementJJD getLink() {
		return (ImplementJJD) getElementToEdit();
	}
