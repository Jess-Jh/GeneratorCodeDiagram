 ...
 * @generated
 */
public class AssociationJJDReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public AssociationJJDReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AssociationJJD) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return ConcreteBaseItemSemanticEditPolicy.getLinkConstraints().canExistAssociationJJD_4004(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected AssociationJJD getLink() {
		return (AssociationJJD) getElementToEdit();
	}
