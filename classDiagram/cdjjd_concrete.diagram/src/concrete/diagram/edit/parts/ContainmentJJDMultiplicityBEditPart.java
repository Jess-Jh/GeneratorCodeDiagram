 ...
 * @generated
 */
public class ContainmentJJDMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcreteVisualIDRegistry
				.getType(concrete.diagram.edit.parts.ContainmentJJDMultiplicityBEditPart.VISUAL_ID), new Point(-50, 5));
	}

	/**
	* @generated
	*/
	public ContainmentJJDMultiplicityBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.ContainmentJJD_4003, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.ContainmentJJDMultiplicityBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentJJDTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentJJDTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentJJDTargetLabelFigure() {
			this.setText("Target");
		}
