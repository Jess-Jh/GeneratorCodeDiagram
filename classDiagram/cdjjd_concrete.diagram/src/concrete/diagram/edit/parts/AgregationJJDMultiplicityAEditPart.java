 ...
 * @generated
 */
public class AgregationJJDMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcreteVisualIDRegistry
				.getType(concrete.diagram.edit.parts.AgregationJJDMultiplicityAEditPart.VISUAL_ID), new Point(-50, 5));
	}

	/**
	* @generated
	*/
	public AgregationJJDMultiplicityAEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AgregationJJD_4001, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.AgregationJJDMultiplicityAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationJJDSourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationJJDSourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationJJDSourceLabelFigure() {
			this.setText("Source");
		}
