 ...
 * @generated
 */
public class ContainmentJJDRolB2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.ContainmentJJDRolB2EditPart.VISUAL_ID),
				new Point(-50, 5));
	}
	...
	* @generated
	*/
	public ContainmentJJDRolB2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.ContainmentJJD_4003, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.ContainmentJJDRolB2EditPart.VISUAL_ID));
		}
		return parser;
	}
