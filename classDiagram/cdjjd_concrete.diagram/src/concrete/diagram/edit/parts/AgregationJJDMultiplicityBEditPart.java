 ...
 * @generated
 */
public class AgregationJJDMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcreteVisualIDRegistry
				.getType(concrete.diagram.edit.parts.AgregationJJDMultiplicityBEditPart.VISUAL_ID), new Point(-50, 5));
	}

	/**
	* @generated
	*/
	public AgregationJJDMultiplicityBEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AgregationJJD_4001, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.AgregationJJDMultiplicityBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AgregationJJDTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AgregationJJDTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AgregationJJDTargetLabelFigure() {
			this.setText("Target");
		}
