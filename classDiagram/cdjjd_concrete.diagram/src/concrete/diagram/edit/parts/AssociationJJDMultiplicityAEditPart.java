 ...
 * @generated
 */
public class AssociationJJDMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcreteVisualIDRegistry
				.getType(concrete.diagram.edit.parts.AssociationJJDMultiplicityAEditPart.VISUAL_ID), new Point(-50, 5));
	}

	/**
	* @generated
	*/
	public AssociationJJDMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AssociationJJD_4004, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.AssociationJJDMultiplicityAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationJJDSourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationJJDSourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationJJDSourceLabelFigure() {
			this.setText("Source");
		}
