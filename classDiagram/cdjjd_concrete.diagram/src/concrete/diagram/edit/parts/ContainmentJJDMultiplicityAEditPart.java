...
import concrete.diagram.edit.policies.ConcreteTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ContainmentJJDMultiplicityAEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcreteVisualIDRegistry
				.getType(concrete.diagram.edit.parts.ContainmentJJDMultiplicityAEditPart.VISUAL_ID), new Point(-50, 5));
	}

	/**
	* @generated
	*/
	public ContainmentJJDMultiplicityAEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ConcreteTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.ContainmentJJD_4003, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.ContainmentJJDMultiplicityAEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ConcreteEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentJJDSourceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ContainmentJJDSourceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ContainmentJJDSourceLabelFigure() {
			this.setText("Source");
		}
