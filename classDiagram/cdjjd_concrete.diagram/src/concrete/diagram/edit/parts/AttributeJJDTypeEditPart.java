 ...
 * @generated
 */
public class AttributeJJDTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributeJJDTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AttributeJJD_3003, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.AttributeJJDTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
