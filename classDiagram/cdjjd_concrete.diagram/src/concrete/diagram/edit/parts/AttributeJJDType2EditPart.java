 ...
 * @generated
 */
public class AttributeJJDType2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributeJJDType2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AttributeJJD_3005, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.AttributeJJDType2EditPart.VISUAL_ID));
		}
		return parser;
	}
