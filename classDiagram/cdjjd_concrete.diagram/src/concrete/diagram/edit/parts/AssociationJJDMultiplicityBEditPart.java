 ...
 * @generated
 */
public class AssociationJJDMultiplicityBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(ConcreteVisualIDRegistry
				.getType(concrete.diagram.edit.parts.AssociationJJDMultiplicityBEditPart.VISUAL_ID), new Point(-50, 5));
	}

	/**
	* @generated
	*/
	public AssociationJJDMultiplicityBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AssociationJJD_4004, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.AssociationJJDMultiplicityBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AssociationJJDTargetLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AssociationJJDTargetLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AssociationJJDTargetLabelFigure() {
			this.setText("Target");
		}
