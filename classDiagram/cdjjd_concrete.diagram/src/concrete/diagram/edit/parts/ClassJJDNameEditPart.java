 ...
 * @generated
 */
public class ClassJJDNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClassJJDNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.ClassJJD_2002, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.ClassJJDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
