 ...
 * @generated
 */
public class MethodJJDNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MethodJJDNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.MethodJJD_3004, getParserElement(),
					ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.MethodJJDNameEditPart.VISUAL_ID));
		}
		return parser;
	}
