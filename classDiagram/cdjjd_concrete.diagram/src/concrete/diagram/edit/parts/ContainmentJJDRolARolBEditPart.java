 ...
 * @generated
 */
public class ContainmentJJDRolARolBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.ContainmentJJDRolARolBEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ContainmentJJDRolARolBEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.ContainmentJJD_4003, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.ContainmentJJDRolARolBEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ContainmentJJDLabelFigure();
	}
	...
	public class ContainmentJJDLabelFigure extends WrappingLabel {
		 ...
		 * @generated
		 */
		public ContainmentJJDLabelFigure() {
			this.setText("ContainmentJJD");
		}
