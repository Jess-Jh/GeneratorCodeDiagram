 ...
 * @generated
 */
public class AttributeJJDNameTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributeJJDNameTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AttributeJJD_3003, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.AttributeJJDNameTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
