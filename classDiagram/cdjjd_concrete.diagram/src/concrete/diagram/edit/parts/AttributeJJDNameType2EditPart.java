 ...
 * @generated
 */
public class AttributeJJDNameType2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AttributeJJDNameType2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return ConcreteElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ConcreteParserProvider.getParser(ConcreteElementTypes.AttributeJJD_3005, getParserElement(),
					ConcreteVisualIDRegistry
							.getType(concrete.diagram.edit.parts.AttributeJJDNameType2EditPart.VISUAL_ID));
		}
		return parser;
	}
