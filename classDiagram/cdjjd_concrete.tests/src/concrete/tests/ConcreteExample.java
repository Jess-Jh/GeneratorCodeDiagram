...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>concrete</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConcreteExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ConcretePackage.eNS_URI, 
			 ConcretePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				ModelFactoryConcreteJJD root = ConcreteFactory.eINSTANCE.createModelFactoryConcreteJJD();
