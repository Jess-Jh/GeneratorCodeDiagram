 ...
 * </p>
 * <ul>
 *   <li>{@link relationalmodel.impl.TableImpl#getName <em>Name</em>}</li>
 *   <li>{@link relationalmodel.impl.TableImpl#getListColumns <em>List Columns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends EObjectImpl implements Table {
	...
	protected EClass eStaticClass() {
		return RelationalmodelPackage.Literals.TABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelationalmodelPackage.TABLE__NAME, oldName, name));
	}
	...
	public EList<Column> getListColumns() {
		if (listColumns == null) {
			listColumns = new EObjectContainmentEList<Column>(Column.class, this, RelationalmodelPackage.TABLE__LIST_COLUMNS);
		}
		return listColumns;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelationalmodelPackage.TABLE__LIST_COLUMNS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RelationalmodelPackage.TABLE__NAME:
				return getName();
			case RelationalmodelPackage.TABLE__LIST_COLUMNS:
