 ...
 * </p>
 * <ul>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getRolA <em>Rol A</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getRolB <em>Rol B</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getNavigabilityA <em>Navigability A</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getNavigabilityB <em>Navigability B</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getMultiplicityA <em>Multiplicity A</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getMultiplicityB <em>Multiplicity B</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getSource <em>Source</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.RelationTablesImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationTablesImpl extends EObjectImpl implements RelationTables {
	...
	protected EClass eStaticClass() {
		return AbstractrelationalmodelPackage.Literals.RELATION_TABLES;
	}
	...
	public void setRolA(String newRolA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__ROL_A, oldRolA, rolA));
	}
	...
	public void setRolB(String newRolB) {
		...
		rolB = newRolB;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__ROL_B, oldRolB, rolB));
	}
	...
	public void setNavigabilityA(String newNavigabilityA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__NAVIGABILITY_A, oldNavigabilityA, navigabilityA));
	}
	...
	public void setNavigabilityB(String newNavigabilityB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__NAVIGABILITY_B, oldNavigabilityB, navigabilityB));
	}
	...
	public void setMultiplicityA(String newMultiplicityA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__MULTIPLICITY_A, oldMultiplicityA, multiplicityA));
	}
	...
	public void setMultiplicityB(String newMultiplicityB) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__MULTIPLICITY_B, oldMultiplicityB, multiplicityB));
	}
	...
	public Table getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractrelationalmodelPackage.RELATION_TABLES__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Table newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__SOURCE, oldSource, source));
	}
	...
	public Table getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AbstractrelationalmodelPackage.RELATION_TABLES__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(Table newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.RELATION_TABLES__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractrelationalmodelPackage.RELATION_TABLES__ROL_A:
				return getRolA();
			case AbstractrelationalmodelPackage.RELATION_TABLES__ROL_B:
				return getRolB();
			case AbstractrelationalmodelPackage.RELATION_TABLES__NAVIGABILITY_A:
				return getNavigabilityA();
			case AbstractrelationalmodelPackage.RELATION_TABLES__NAVIGABILITY_B:
				return getNavigabilityB();
			case AbstractrelationalmodelPackage.RELATION_TABLES__MULTIPLICITY_A:
				return getMultiplicityA();
			case AbstractrelationalmodelPackage.RELATION_TABLES__MULTIPLICITY_B:
				return getMultiplicityB();
			case AbstractrelationalmodelPackage.RELATION_TABLES__SOURCE:
				if (resolve) return getSource();
				return basicGetSource();
			case AbstractrelationalmodelPackage.RELATION_TABLES__TARGET:
