 ...
 * </p>
 * <ul>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#getName <em>Name</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isIsPrimaryKey <em>Is Primary Key</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isNotNull <em>Not Null</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isUniqueIndex <em>Unique Index</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isIsBinaryColumn <em>Is Binary Column</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isUnsignedDataType <em>Unsigned Data Type</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isFillUpValuesColumn <em>Fill Up Values Column</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isIsAutoIncremental <em>Is Auto Incremental</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#isGeneratedColumn <em>Generated Column</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link abstractrelationalmodel.impl.ColumnImpl#getListDataType <em>List Data Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColumnImpl extends EObjectImpl implements Column {
	...
	protected EClass eStaticClass() {
		return AbstractrelationalmodelPackage.Literals.COLUMN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__NAME, oldName, name));
	}
	...
	public NotificationChain basicSetDataType(DataType newDataType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__DATA_TYPE, oldDataType, newDataType);
	...
	public void setDataType(DataType newDataType) {
		if (newDataType != dataType) {
			...
			if (dataType != null)
				msgs = ((InternalEObject)dataType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AbstractrelationalmodelPackage.COLUMN__DATA_TYPE, null, msgs);
			if (newDataType != null)
				msgs = ((InternalEObject)newDataType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AbstractrelationalmodelPackage.COLUMN__DATA_TYPE, null, msgs);
			msgs = basicSetDataType(newDataType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__DATA_TYPE, newDataType, newDataType));
	}
	...
	public void setIsPrimaryKey(boolean newIsPrimaryKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__IS_PRIMARY_KEY, oldIsPrimaryKey, isPrimaryKey));
	}
	...
	public void setNotNull(boolean newNotNull) {
		...
		notNull = newNotNull;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__NOT_NULL, oldNotNull, notNull));
	}
	...
	public void setUniqueIndex(boolean newUniqueIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__UNIQUE_INDEX, oldUniqueIndex, uniqueIndex));
	}
	...
	public void setIsBinaryColumn(boolean newIsBinaryColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__IS_BINARY_COLUMN, oldIsBinaryColumn, isBinaryColumn));
	}
	...
	public void setUnsignedDataType(boolean newUnsignedDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__UNSIGNED_DATA_TYPE, oldUnsignedDataType, unsignedDataType));
	}
	...
	public void setFillUpValuesColumn(boolean newFillUpValuesColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__FILL_UP_VALUES_COLUMN, oldFillUpValuesColumn, fillUpValuesColumn));
	}
	...
	public void setIsAutoIncremental(boolean newIsAutoIncremental) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__IS_AUTO_INCREMENTAL, oldIsAutoIncremental, isAutoIncremental));
	}
	...
	public void setGeneratedColumn(boolean newGeneratedColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__GENERATED_COLUMN, oldGeneratedColumn, generatedColumn));
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractrelationalmodelPackage.COLUMN__EXPRESSION, oldExpression, expression));
	}
	...
	public EList<DataType> getListDataType() {
		if (listDataType == null) {
			listDataType = new EObjectContainmentEList<DataType>(DataType.class, this, AbstractrelationalmodelPackage.COLUMN__LIST_DATA_TYPE);
		}
		return listDataType;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AbstractrelationalmodelPackage.COLUMN__DATA_TYPE:
				return basicSetDataType(null, msgs);
			case AbstractrelationalmodelPackage.COLUMN__LIST_DATA_TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractrelationalmodelPackage.COLUMN__NAME:
				return getName();
			case AbstractrelationalmodelPackage.COLUMN__DATA_TYPE:
				return getDataType();
			case AbstractrelationalmodelPackage.COLUMN__IS_PRIMARY_KEY:
				return isIsPrimaryKey();
			case AbstractrelationalmodelPackage.COLUMN__NOT_NULL:
				return isNotNull();
			case AbstractrelationalmodelPackage.COLUMN__UNIQUE_INDEX:
				return isUniqueIndex();
			case AbstractrelationalmodelPackage.COLUMN__IS_BINARY_COLUMN:
				return isIsBinaryColumn();
			case AbstractrelationalmodelPackage.COLUMN__UNSIGNED_DATA_TYPE:
				return isUnsignedDataType();
			case AbstractrelationalmodelPackage.COLUMN__FILL_UP_VALUES_COLUMN:
				return isFillUpValuesColumn();
			case AbstractrelationalmodelPackage.COLUMN__IS_AUTO_INCREMENTAL:
				return isIsAutoIncremental();
			case AbstractrelationalmodelPackage.COLUMN__GENERATED_COLUMN:
				return isGeneratedColumn();
			case AbstractrelationalmodelPackage.COLUMN__EXPRESSION:
