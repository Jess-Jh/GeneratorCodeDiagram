 ...
 * @generated
 */
public class ContainmentJJDRolBEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ConcreteVisualIDRegistry.getType(concrete.diagram.edit.parts.ContainmentJJDRolBEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ContainmentJJDRolBEditPart(View view) {
		super(view);
	}
