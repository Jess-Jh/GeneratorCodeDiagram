 ...
 * </p>
 * <ul>
 *   <li>{@link concrete.impl.PackageJJDImpl#getName <em>Name</em>}</li>
 *   <li>{@link concrete.impl.PackageJJDImpl#getNameSpace <em>Name Space</em>}</li>
 *   <li>{@link concrete.impl.PackageJJDImpl#getSubPackagesJJD <em>Sub Packages JJD</em>}</li>
 *   <li>{@link concrete.impl.PackageJJDImpl#getListClassJJD <em>List Class JJD</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PackageJJDImpl extends EObjectImpl implements PackageJJD {
	...
	protected EClass eStaticClass() {
		return ConcretePackage.Literals.PACKAGE_JJD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.PACKAGE_JJD__NAME, oldName, name));
	}
	...
	public void setNameSpace(String newNameSpace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConcretePackage.PACKAGE_JJD__NAME_SPACE, oldNameSpace, nameSpace));
	}
	...
	public EList<PackageJJD> getSubPackagesJJD() {
		if (subPackagesJJD == null) {
			subPackagesJJD = new EObjectContainmentEList<PackageJJD>(PackageJJD.class, this, ConcretePackage.PACKAGE_JJD__SUB_PACKAGES_JJD);
		}
	...
	public EList<ClassJJD> getListClassJJD() {
		if (listClassJJD == null) {
			listClassJJD = new EObjectContainmentEList<ClassJJD>(ClassJJD.class, this, ConcretePackage.PACKAGE_JJD__LIST_CLASS_JJD);
		}
		return listClassJJD;
	}
