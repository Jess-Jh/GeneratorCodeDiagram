...
public class DialogAppbarView extends Dialog {
    private Text textName;
	private Text textColor;
	private Combo comboAlignment;
    private uidiagram.Appbar model;
     ...
     * @param model
     */
    public DialogAppbarView(Shell parentShell, uidiagram.Appbar model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.Appbar appbar;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.Appbar appbar) {
        ...
        {
        	if(textName != null && !(textName.getText().isEmpty()))  appbar.setName(textName.getText()); 
        	if(textColor != null && !(textColor.getText().isEmpty())) appbar.setBackgroundColor(textColor.getText());
        	if(textColor != null && !(textColor.getText().isEmpty())) appbar.setBackgroundColor(textColor.getText());
        	if(!(comboAlignment.getText().isEmpty())) appbar.setAlignment(comboAlignment.getText());
