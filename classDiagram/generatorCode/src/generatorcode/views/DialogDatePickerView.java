...
public class DialogDatePickerView extends Dialog {
    private Text textName;
    private Text textColor;
    private Combo comboAlignment;
    private uidiagram.DatePicker model;
     ...
     * @param model
     */
    public DialogDatePickerView(Shell parentShell, uidiagram.DatePicker model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
    ...
    /**
     * Create contents of the datePicker bar.
     * @param parent
     */
    @Override
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.DatePicker datePicker;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.DatePicker datePicker) {
        ...
        protected void doExecute() {
        	if(textName != null && !(textName.getText().isEmpty()))  datePicker.setName(textName.getText()); 
        	if(textColor != null && !(textColor.getText().isEmpty())) datePicker.setBackgroundColor(textColor.getText());
        	if(!(comboAlignment.getText().isEmpty())) datePicker.setAlignment(comboAlignment.getText());
