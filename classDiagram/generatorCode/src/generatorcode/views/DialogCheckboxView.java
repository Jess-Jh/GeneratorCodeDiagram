...
public class DialogCheckboxView extends Dialog {
    private Text textName;
    private Text textColor;
    private Combo comboAlignment;
    private uidiagram.Checkbox model;
     ...
     * @param model
     */
    public DialogCheckboxView(Shell parentShell, uidiagram.Checkbox model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
    ...
    /**
     * Create contents of the checkbox bar.
     * @param parent
     */
    @Override
...
//        }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.Checkbox checkbox;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.Checkbox checkbox) {
        ...
        {
        	if(textName != null && !(textName.getText().isEmpty()))  checkbox.setName(textName.getText()); 
        	if(textColor != null && !(textColor.getText().isEmpty())) checkbox.setBackgroundColor(textColor.getText());
        	if(!(comboAlignment.getText().isEmpty())) checkbox.setAlignment(comboAlignment.getText());
