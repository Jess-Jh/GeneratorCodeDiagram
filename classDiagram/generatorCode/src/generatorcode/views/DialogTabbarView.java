...
//        }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        {
        	if(textName != null && !(textName.getText().isEmpty()))  tabbar.setName(textName.getText()); 
        	if(textColor != null && !(textColor.getText().isEmpty())) tabbar.setBackgroundColor(textColor.getText());
