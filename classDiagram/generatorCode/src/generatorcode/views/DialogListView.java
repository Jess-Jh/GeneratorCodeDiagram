...
public class DialogListView extends Dialog {
    ...
    private uidiagram.ListView model;
     ...
     * @param model
     */
    public DialogListView(Shell parentShell, uidiagram.ListView model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
...
//        }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.ListView listView;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.ListView listView) {
        ...
        {
        	listView.setName(textName.getText());                
        }
