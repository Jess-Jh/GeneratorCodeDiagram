...
public class DialogTableView extends Dialog {
     ...
     * @param model
     */
    public DialogTableView(Shell parentShell, uidiagram.Table model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
...
//        }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.Table table;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.Table table) {
        ...
        {
        	if(textName != null && !(textName.getText().isEmpty()))  table.setName(textName.getText()); 
        	if(textColor != null && !(textColor.getText().isEmpty())) table.setBackgroundColor(textColor.getText());
