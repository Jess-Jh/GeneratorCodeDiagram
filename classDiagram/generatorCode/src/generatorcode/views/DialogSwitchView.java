...
public class DialogSwitchView extends Dialog {
     ...
     * @param model
     */
    public DialogSwitchView(Shell parentShell, uidiagram.Switch model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
...
//        }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.Switch switches;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.Switch switches) {
        ...
        protected void doExecute()
        {
        	...
        	if(!(comboAlignment.getText().isEmpty())) switches.setAlignment(comboAlignment.getText());
