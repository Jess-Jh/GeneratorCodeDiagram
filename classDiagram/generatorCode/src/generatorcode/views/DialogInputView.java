...
public class DialogInputView extends Dialog {
     ...
     * @param model
     */
    public DialogInputView(Shell parentShell, uidiagram.Input model, TransactionalEditingDomain domain) {
        super(parentShell);
        this.model = model;
        this.domain = domain;
    }
...
//        }
    ...
    public class ChangeOPerationDialogCommand extends RecordingCommand{
        ...
        private uidiagram.Input input;
        TransactionalEditingDomain transactionalEditingDomain2;
        
        public ChangeOPerationDialogCommand(TransactionalEditingDomain transactionalEditingDomain, uidiagram.Input input) {
        ...
        {
        	input.setName(textName.getText());                
        }
