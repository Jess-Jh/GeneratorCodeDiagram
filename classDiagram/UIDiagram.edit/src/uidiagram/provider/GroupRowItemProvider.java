...
/**
 * This is the item provider adapter for a {@link uidiagram.GroupRow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupRowItemProvider extends TemplateWidgetItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GroupRowItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UidiagramPackage.Literals.GROUP_ROW__LIST_TEMPLATE_WIDGET);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GroupRow"));
	}
	...
	public String getText(Object object) {
		String label = ((GroupRow)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_GroupRow_type") :
			getString("_UI_GroupRow_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GroupRow.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UidiagramPackage.Literals.GROUP_ROW__LIST_TEMPLATE_WIDGET,
