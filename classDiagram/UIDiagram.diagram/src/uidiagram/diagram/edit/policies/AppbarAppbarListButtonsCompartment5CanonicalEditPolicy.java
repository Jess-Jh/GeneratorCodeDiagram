 ...
 * @generated
 */
public class AppbarAppbarListButtonsCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAppbar_ListButtons();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListButtonsCompartment_7041SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ButtonEditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListButtonsCompartment_7041SemanticChildren((View) getHost().getModel());
