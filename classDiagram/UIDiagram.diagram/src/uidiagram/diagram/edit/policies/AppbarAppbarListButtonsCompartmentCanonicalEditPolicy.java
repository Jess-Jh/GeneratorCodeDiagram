 ...
 * @generated
 */
public class AppbarAppbarListButtonsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListButtonsCompartment_7018SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListButtonsCompartment_7018SemanticChildren((View) getHost().getModel());
