 ...
 * @generated
 */
public class TabbarTabbarListButtonsCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTabbarTabbarListButtonsCompartment_7033SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTabbarTabbarListButtonsCompartment_7033SemanticChildren((View) getHost().getModel());
