 ...
 * @generated
 */
public class TableTableListCoulmnsCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableTableListCoulmnsCompartment_7014SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableTableListCoulmnsCompartment_7014SemanticChildren((View) getHost().getModel());
