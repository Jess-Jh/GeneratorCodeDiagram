 ...
 * @generated
 */
public class UserInterfaceUserInterfaceListTemplateWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getUserInterface_ListTemplateWidget();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListTemplateWidgetCompartment_7001SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getUserInterfaceUserInterfaceListTemplateWidgetCompartment_7001SemanticChildren(
