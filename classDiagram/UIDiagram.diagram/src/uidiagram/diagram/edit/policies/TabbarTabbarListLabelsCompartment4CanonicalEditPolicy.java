 ...
 * @generated
 */
public class TabbarTabbarListLabelsCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getTabbar_ListLabels();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTabbarTabbarListLabelsCompartment_7034SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Label2EditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTabbarTabbarListLabelsCompartment_7034SemanticChildren((View) getHost().getModel());
