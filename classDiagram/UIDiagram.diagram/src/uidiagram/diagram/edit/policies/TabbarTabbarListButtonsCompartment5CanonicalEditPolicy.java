 ...
 * @generated
 */
public class TabbarTabbarListButtonsCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getTabbar_ListButtons();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTabbarTabbarListButtonsCompartment_7025SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Button2EditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTabbarTabbarListButtonsCompartment_7025SemanticChildren((View) getHost().getModel());
