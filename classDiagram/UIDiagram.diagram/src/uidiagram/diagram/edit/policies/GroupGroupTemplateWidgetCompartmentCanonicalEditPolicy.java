 ...
 * @generated
 */
public class GroupGroupTemplateWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupGroupTemplateWidgetCompartment_7002SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupGroupTemplateWidgetCompartment_7002SemanticChildren((View) getHost().getModel());
