 ...
 * @generated
 */
public class AppbarAppbarListLabelsCompartment5CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListLabelsCompartment_7042SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListLabelsCompartment_7042SemanticChildren((View) getHost().getModel());
