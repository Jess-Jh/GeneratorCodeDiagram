 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getListViewListViewListTemplateWidgetCompartment_7034SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getListViewListViewListTemplateWidgetCompartment_7034SemanticChildren((View) getHost().getModel());
