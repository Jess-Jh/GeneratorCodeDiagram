 ...
 * @generated
 */
public class GroupColumnGroupColumnListTemplateWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupColumnGroupColumnListTemplateWidgetCompartment_7004SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupColumnGroupColumnListTemplateWidgetCompartment_7004SemanticChildren(
