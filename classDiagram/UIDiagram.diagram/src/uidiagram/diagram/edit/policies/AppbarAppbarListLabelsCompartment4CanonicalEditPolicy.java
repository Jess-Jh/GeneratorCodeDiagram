 ...
 * @generated
 */
public class AppbarAppbarListLabelsCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListLabelsCompartment_7041SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListLabelsCompartment_7041SemanticChildren((View) getHost().getModel());
