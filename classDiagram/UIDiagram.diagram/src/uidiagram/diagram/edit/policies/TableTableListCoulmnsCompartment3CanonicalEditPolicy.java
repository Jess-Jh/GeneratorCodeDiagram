 ...
 * @generated
 */
public class TableTableListCoulmnsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableTableListCoulmnsCompartment_7013SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getTableTableListCoulmnsCompartment_7013SemanticChildren((View) getHost().getModel());
