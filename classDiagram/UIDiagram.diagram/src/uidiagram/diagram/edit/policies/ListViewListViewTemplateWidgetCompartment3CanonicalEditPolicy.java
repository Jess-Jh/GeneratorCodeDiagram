 ...
 * @generated
 */
public class ListViewListViewTemplateWidgetCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getListViewListViewTemplateWidgetCompartment_7030SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getListViewListViewTemplateWidgetCompartment_7030SemanticChildren((View) getHost().getModel());
