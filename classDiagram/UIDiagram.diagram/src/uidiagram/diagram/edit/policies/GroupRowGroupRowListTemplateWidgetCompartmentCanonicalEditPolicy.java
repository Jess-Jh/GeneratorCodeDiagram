 ...
 * @generated
 */
public class GroupRowGroupRowListTemplateWidgetCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupRowGroupRowListTemplateWidgetCompartment_7006SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupRowGroupRowListTemplateWidgetCompartment_7006SemanticChildren((View) getHost().getModel());
