 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getListViewListViewListTemplateWidgetCompartment_7037SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getListViewListViewListTemplateWidgetCompartment_7037SemanticChildren((View) getHost().getModel());
