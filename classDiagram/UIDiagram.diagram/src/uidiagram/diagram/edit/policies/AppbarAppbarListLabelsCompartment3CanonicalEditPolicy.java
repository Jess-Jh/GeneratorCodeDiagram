 ...
 * @generated
 */
public class AppbarAppbarListLabelsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return UidiagramPackage.eINSTANCE.getAppbar_ListLabels();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListLabelsCompartment_7028SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return LabelEditPart.VISUAL_ID == UidiagramVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getAppbarAppbarListLabelsCompartment_7028SemanticChildren((View) getHost().getModel());
