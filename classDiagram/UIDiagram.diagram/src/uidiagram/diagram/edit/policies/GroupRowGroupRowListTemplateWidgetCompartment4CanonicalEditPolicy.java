 ...
 * @generated
 */
public class GroupRowGroupRowListTemplateWidgetCompartment4CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupRowGroupRowListTemplateWidgetCompartment_7025SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupRowGroupRowListTemplateWidgetCompartment_7025SemanticChildren((View) getHost().getModel());
