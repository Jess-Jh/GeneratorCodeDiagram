...
public class GroupRowGroupRowListTemplateWidgetCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupRowGroupRowListTemplateWidgetCompartment_7017SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<UidiagramNodeDescriptor> childDescriptors = UidiagramDiagramUpdater
				.getGroupRowGroupRowListTemplateWidgetCompartment_7017SemanticChildren((View) getHost().getModel());
