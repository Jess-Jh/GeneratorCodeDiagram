 ...
 * @generated
 */
public class LabelName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LabelName4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UidiagramParserProvider.getParser(UidiagramElementTypes.Label_3053, getParserElement(),
					UidiagramVisualIDRegistry.getType(uidiagram.diagram.edit.parts.LabelName4EditPart.VISUAL_ID));
		}
		return parser;
	}
