...
import uidiagram.diagram.edit.policies.GroupColumn3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumn3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GroupColumn3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupColumn3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupColumnName3EditPart) {
			((GroupColumnName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupColumnLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			pane.remove(((GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupColumnName3EditPart.VISUAL_ID));
	}
