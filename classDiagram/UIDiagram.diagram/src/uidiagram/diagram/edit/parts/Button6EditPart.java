...
import uidiagram.diagram.edit.policies.Button6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Button6EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Button6EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Button6ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonName6EditPart) {
			((ButtonName6EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ButtonName6EditPart.VISUAL_ID));
	}
