...
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupTemplateWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupTemplateWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupTemplateWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupGroupTemplateWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GroupGroupTemplateWidgetCompartmentCanonicalEditPolicy());
	}
