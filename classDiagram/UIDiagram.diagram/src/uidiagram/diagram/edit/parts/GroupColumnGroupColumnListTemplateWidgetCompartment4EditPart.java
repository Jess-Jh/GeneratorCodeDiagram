...
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment4CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumnGroupColumnListTemplateWidgetCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupColumnGroupColumnListTemplateWidgetCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupColumnGroupColumnListTemplateWidgetCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment4CanonicalEditPolicy());
	}
