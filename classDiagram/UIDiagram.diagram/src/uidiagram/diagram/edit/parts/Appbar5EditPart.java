...
import uidiagram.diagram.edit.policies.Appbar5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Appbar5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Appbar5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Appbar5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AppbarName5EditPart) {
			((AppbarName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAppbarLabelFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListButtonsCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListButtonsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AppbarAppbarListButtonsCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListLabelsCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListLabelsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AppbarAppbarListLabelsCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AppbarAppbarListButtonsCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListButtonsCompartmentFigure();
			pane.remove(((AppbarAppbarListButtonsCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListLabelsCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListLabelsCompartmentFigure();
			pane.remove(((AppbarAppbarListLabelsCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AppbarAppbarListButtonsCompartment5EditPart) {
			return getPrimaryShape().getAppbarListButtonsCompartmentFigure();
		}
		if (editPart instanceof AppbarAppbarListLabelsCompartment5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AppbarName5EditPart.VISUAL_ID));
	}
