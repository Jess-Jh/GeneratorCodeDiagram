 ...
 * @generated
 */
public class GroupColumn2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GroupColumn2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupColumn2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupColumnName2EditPart) {
			((GroupColumnName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupColumnLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			pane.remove(((GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupColumnName2EditPart.VISUAL_ID));
	}
