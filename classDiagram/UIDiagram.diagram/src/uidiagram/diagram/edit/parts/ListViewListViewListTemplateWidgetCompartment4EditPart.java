...
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment4CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartment4EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ListViewListViewListTemplateWidgetCompartment4EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ListViewListViewListTemplateWidgetCompartment4EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ListViewListViewListTemplateWidgetCompartment4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ListViewListViewListTemplateWidgetCompartment4CanonicalEditPolicy());
	}
