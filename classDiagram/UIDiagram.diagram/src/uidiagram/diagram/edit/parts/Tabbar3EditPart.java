...
import uidiagram.diagram.edit.policies.Tabbar3ItemSemanticEditPolicy;
import uidiagram.diagram.part.UidiagramVisualIDRegistry;

/**
 * @generated
 */
public class Tabbar3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Tabbar3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Tabbar3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TabbarName3EditPart) {
			((TabbarName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTabbarLabelFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListButtonsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListButtonsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabbarTabbarListButtonsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListLabelsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListLabelsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabbarTabbarListLabelsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TabbarTabbarListButtonsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListButtonsCompartmentFigure();
			pane.remove(((TabbarTabbarListButtonsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListLabelsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListLabelsCompartmentFigure();
			pane.remove(((TabbarTabbarListLabelsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TabbarTabbarListButtonsCompartment3EditPart) {
			return getPrimaryShape().getTabbarListButtonsCompartmentFigure();
		}
		if (editPart instanceof TabbarTabbarListLabelsCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(TabbarName3EditPart.VISUAL_ID));
	}
