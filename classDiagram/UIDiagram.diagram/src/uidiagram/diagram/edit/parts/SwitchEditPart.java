...
public class SwitchEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SwitchNameEditPart) {
			((SwitchNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSwitchLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(SwitchNameEditPart.VISUAL_ID));
	}
