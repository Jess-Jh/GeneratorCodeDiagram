...
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartment5CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupTemplateWidgetCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupTemplateWidgetCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupTemplateWidgetCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupGroupTemplateWidgetCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupGroupTemplateWidgetCompartment5CanonicalEditPolicy());
	}
