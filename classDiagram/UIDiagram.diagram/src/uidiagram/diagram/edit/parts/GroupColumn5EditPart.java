...
import uidiagram.diagram.edit.policies.GroupColumn5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumn5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GroupColumn5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupColumn5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupColumnName5EditPart) {
			((GroupColumnName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupColumnLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			pane.remove(((GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupColumnName5EditPart.VISUAL_ID));
	}
