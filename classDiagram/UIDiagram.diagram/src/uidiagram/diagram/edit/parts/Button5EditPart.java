...
import uidiagram.diagram.edit.policies.Button5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Button5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Button5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Button5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonName5EditPart) {
			((ButtonName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ButtonName5EditPart.VISUAL_ID));
	}
