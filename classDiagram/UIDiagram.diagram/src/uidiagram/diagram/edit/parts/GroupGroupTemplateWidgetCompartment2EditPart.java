...
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupTemplateWidgetCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupTemplateWidgetCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupTemplateWidgetCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupGroupTemplateWidgetCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupGroupTemplateWidgetCompartment2CanonicalEditPolicy());
	}
