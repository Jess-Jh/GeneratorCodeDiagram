...
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartment3CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupGroupTemplateWidgetCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupGroupTemplateWidgetCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupGroupTemplateWidgetCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupGroupTemplateWidgetCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupGroupTemplateWidgetCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupGroupTemplateWidgetCompartment3CanonicalEditPolicy());
	}
