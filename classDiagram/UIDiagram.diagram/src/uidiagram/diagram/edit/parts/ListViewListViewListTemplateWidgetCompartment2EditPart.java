...
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ListViewListViewListTemplateWidgetCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ListViewListViewListTemplateWidgetCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ListViewListViewListTemplateWidgetCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ListViewListViewListTemplateWidgetCompartment2CanonicalEditPolicy());
	}
	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UidiagramElementTypes.Group_3066) {
				return this;
			}
