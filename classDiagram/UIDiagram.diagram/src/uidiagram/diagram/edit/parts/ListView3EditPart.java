...
public class ListView3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ListViewListViewTemplateWidgetCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getListViewTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ListViewListViewTemplateWidgetCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ListViewListViewTemplateWidgetCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getListViewTemplateWidgetCompartmentFigure();
			pane.remove(((ListViewListViewTemplateWidgetCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ListViewListViewTemplateWidgetCompartment3EditPart) {
