...
import uidiagram.diagram.edit.policies.ListView3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListView3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ListView3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ListView3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ListViewName3EditPart) {
			((ListViewName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureListViewLabelFigure());
			return true;
		}
		if (childEditPart instanceof ListViewListViewListTemplateWidgetCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getListViewListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ListViewListViewListTemplateWidgetCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ListViewListViewListTemplateWidgetCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getListViewListTemplateWidgetCompartmentFigure();
			pane.remove(((ListViewListViewListTemplateWidgetCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ListViewListViewListTemplateWidgetCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ListViewName3EditPart.VISUAL_ID));
	}
