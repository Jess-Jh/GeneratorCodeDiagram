 ...
 * @generated
 */
public class TabbarEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public TabbarEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TabbarItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TabbarNameEditPart) {
			((TabbarNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureTabbarLabelFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListButtonsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTabbarListButtonsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabbarTabbarListButtonsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListLabelsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTabbarListLabelsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabbarTabbarListLabelsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TabbarTabbarListButtonsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTabbarListButtonsCompartmentFigure();
			pane.remove(((TabbarTabbarListButtonsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListLabelsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getTabbarListLabelsCompartmentFigure();
			pane.remove(((TabbarTabbarListLabelsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TabbarTabbarListButtonsCompartmentEditPart) {
			return getPrimaryShape().getTabbarListButtonsCompartmentFigure();
		}
		if (editPart instanceof TabbarTabbarListLabelsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(TabbarNameEditPart.VISUAL_ID));
	}
