...
import uidiagram.diagram.edit.policies.Group5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Group5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Group5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Group5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenGroupEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupName5EditPart) {
			((GroupName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupGroupListTemplateWidgetCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getGroupListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupGroupListTemplateWidgetCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupGroupListTemplateWidgetCompartment5EditPart) {
			IFigure pane = getPrimaryShape().getGroupListTemplateWidgetCompartmentFigure();
			pane.remove(((GroupGroupListTemplateWidgetCompartment5EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupGroupListTemplateWidgetCompartment5EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupName5EditPart.VISUAL_ID));
	}
