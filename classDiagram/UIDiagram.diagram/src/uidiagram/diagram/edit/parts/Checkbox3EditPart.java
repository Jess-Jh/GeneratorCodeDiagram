...
import uidiagram.diagram.edit.policies.Checkbox3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Checkbox3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Checkbox3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Checkbox3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenCheckboxEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckboxName3EditPart) {
			((CheckboxName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckboxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckboxName3EditPart.VISUAL_ID));
	}
