...
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment5CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupColumnGroupColumnListTemplateWidgetCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment5CanonicalEditPolicy());
	}
