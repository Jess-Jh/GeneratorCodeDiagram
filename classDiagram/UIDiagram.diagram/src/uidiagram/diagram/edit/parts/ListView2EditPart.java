 ...
 * @generated
 */
public class ListView2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public ListView2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ListView2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ListViewName2EditPart) {
			((ListViewName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureListViewLabelFigure());
			return true;
		}
		if (childEditPart instanceof ListViewListViewListTemplateWidgetCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getListViewListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ListViewListViewListTemplateWidgetCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ListViewListViewListTemplateWidgetCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getListViewListTemplateWidgetCompartmentFigure();
			pane.remove(((ListViewListViewListTemplateWidgetCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ListViewListViewListTemplateWidgetCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ListViewName2EditPart.VISUAL_ID));
	}
