...
import uidiagram.diagram.edit.policies.Input4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Input4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Input4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Input4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputName4EditPart) {
			((InputName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(InputName4EditPart.VISUAL_ID));
	}
