...
import uidiagram.diagram.edit.policies.Checkbox4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Checkbox4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Checkbox4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Checkbox4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckboxName4EditPart) {
			((CheckboxName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckboxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckboxName4EditPart.VISUAL_ID));
	}
