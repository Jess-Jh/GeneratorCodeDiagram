...
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartmentCanonicalEditPolicy());
	}
