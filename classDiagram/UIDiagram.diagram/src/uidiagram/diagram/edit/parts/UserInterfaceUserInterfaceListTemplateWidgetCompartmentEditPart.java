...
import uidiagram.diagram.edit.policies.UserInterfaceUserInterfaceListTemplateWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.UserInterfaceUserInterfaceListTemplateWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class UserInterfaceUserInterfaceListTemplateWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public UserInterfaceUserInterfaceListTemplateWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.UserInterfaceUserInterfaceListTemplateWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UserInterfaceUserInterfaceListTemplateWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new UserInterfaceUserInterfaceListTemplateWidgetCompartmentCanonicalEditPolicy());
	}
