...
import uidiagram.diagram.edit.policies.Button4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Button4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Button4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Button4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenButtonEditPolicy()); // XXX need an SCR to runtime to have another abstract superclass that would let children add reasonable editpolicies
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonName4EditPart) {
			((ButtonName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ButtonName4EditPart.VISUAL_ID));
	}
