...
import uidiagram.diagram.edit.policies.Appbar2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Appbar2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Appbar2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Appbar2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AppbarName2EditPart) {
			((AppbarName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAppbarLabelFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListButtonsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListButtonsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AppbarAppbarListButtonsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListLabelsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListLabelsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AppbarAppbarListLabelsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AppbarAppbarListButtonsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListButtonsCompartmentFigure();
			pane.remove(((AppbarAppbarListButtonsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListLabelsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListLabelsCompartmentFigure();
			pane.remove(((AppbarAppbarListLabelsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AppbarAppbarListButtonsCompartment2EditPart) {
			return getPrimaryShape().getAppbarListButtonsCompartmentFigure();
		}
		if (editPart instanceof AppbarAppbarListLabelsCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AppbarName2EditPart.VISUAL_ID));
	}
