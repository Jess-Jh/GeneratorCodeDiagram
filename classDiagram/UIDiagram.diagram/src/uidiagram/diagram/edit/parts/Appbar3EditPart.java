...
import uidiagram.diagram.edit.policies.Appbar3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Appbar3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Appbar3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Appbar3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AppbarName3EditPart) {
			((AppbarName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAppbarLabelFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListButtonsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListButtonsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AppbarAppbarListButtonsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListLabelsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListLabelsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AppbarAppbarListLabelsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AppbarAppbarListButtonsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListButtonsCompartmentFigure();
			pane.remove(((AppbarAppbarListButtonsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AppbarAppbarListLabelsCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getAppbarListLabelsCompartmentFigure();
			pane.remove(((AppbarAppbarListLabelsCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AppbarAppbarListButtonsCompartment3EditPart) {
			return getPrimaryShape().getAppbarListButtonsCompartmentFigure();
		}
		if (editPart instanceof AppbarAppbarListLabelsCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(AppbarName3EditPart.VISUAL_ID));
	}
