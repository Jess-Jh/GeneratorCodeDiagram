...
import uidiagram.diagram.edit.policies.Button3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Button3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Button3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Button3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonName3EditPart) {
			((ButtonName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ButtonName3EditPart.VISUAL_ID));
	}
