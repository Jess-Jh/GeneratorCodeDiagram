...
import uidiagram.diagram.edit.policies.Label3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Label3EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelName3EditPart) {
			((LabelName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureLabelLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(LabelName3EditPart.VISUAL_ID));
	}
