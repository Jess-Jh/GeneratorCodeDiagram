 ...
 * @generated
 */
public class Switch2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SwitchName2EditPart) {
			((SwitchName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureSwitchLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(SwitchName2EditPart.VISUAL_ID));
	}
