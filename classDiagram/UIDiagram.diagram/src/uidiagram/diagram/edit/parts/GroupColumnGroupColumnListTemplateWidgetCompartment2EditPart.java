...
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment2CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupColumnGroupColumnListTemplateWidgetCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment2CanonicalEditPolicy());
	}
