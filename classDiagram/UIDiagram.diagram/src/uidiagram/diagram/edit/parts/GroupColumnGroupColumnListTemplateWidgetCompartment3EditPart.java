...
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment3CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.GroupColumnGroupColumnListTemplateWidgetCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupColumnGroupColumnListTemplateWidgetCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupColumnGroupColumnListTemplateWidgetCompartment3CanonicalEditPolicy());
	}
