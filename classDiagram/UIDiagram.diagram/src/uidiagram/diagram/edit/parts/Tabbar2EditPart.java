 ...
 * @generated
 */
public class Tabbar2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Tabbar2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TabbarName2EditPart) {
			((TabbarName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureTabbarLabelFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListButtonsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListButtonsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabbarTabbarListButtonsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListLabelsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListLabelsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((TabbarTabbarListLabelsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof TabbarTabbarListButtonsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListButtonsCompartmentFigure();
			pane.remove(((TabbarTabbarListButtonsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof TabbarTabbarListLabelsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getTabbarListLabelsCompartmentFigure();
			pane.remove(((TabbarTabbarListLabelsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof TabbarTabbarListButtonsCompartment2EditPart) {
			return getPrimaryShape().getTabbarListButtonsCompartmentFigure();
		}
		if (editPart instanceof TabbarTabbarListLabelsCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(TabbarName2EditPart.VISUAL_ID));
	}
