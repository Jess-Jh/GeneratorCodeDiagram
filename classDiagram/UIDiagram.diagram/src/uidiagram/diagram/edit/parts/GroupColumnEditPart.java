...
import uidiagram.diagram.edit.policies.GroupColumnItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupColumnEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GroupColumnEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupColumnItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupColumnNameEditPart) {
			((GroupColumnNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupColumnLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupColumnListTemplateWidgetCompartmentFigure();
			pane.remove(((GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupColumnGroupColumnListTemplateWidgetCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(GroupColumnNameEditPart.VISUAL_ID));
	}
