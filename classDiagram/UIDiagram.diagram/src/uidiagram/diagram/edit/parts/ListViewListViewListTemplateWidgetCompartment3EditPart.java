...
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment3CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ListViewListViewListTemplateWidgetCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ListViewListViewListTemplateWidgetCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ListViewListViewListTemplateWidgetCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ListViewListViewListTemplateWidgetCompartment3CanonicalEditPolicy());
	}
