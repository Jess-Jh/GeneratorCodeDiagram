...
import uidiagram.diagram.edit.policies.Input5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Input5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Input5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Input5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputName5EditPart) {
			((InputName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(InputName5EditPart.VISUAL_ID));
	}
