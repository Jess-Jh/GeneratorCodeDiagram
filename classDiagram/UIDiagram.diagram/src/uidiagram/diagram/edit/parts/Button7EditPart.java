...
import uidiagram.diagram.edit.policies.Button7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Button7EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Button7EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Button7ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ButtonName7EditPart) {
			((ButtonName7EditPart) childEditPart).setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(ButtonName7EditPart.VISUAL_ID));
	}
