...
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment5CanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartment5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartment5EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ListViewListViewListTemplateWidgetCompartment5EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ListViewListViewListTemplateWidgetCompartment5EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ListViewListViewListTemplateWidgetCompartment5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ListViewListViewListTemplateWidgetCompartment5CanonicalEditPolicy());
	}
