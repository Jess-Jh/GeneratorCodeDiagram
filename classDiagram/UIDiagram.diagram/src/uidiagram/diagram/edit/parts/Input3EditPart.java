...
import uidiagram.diagram.edit.policies.Input3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Input3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Input3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Input3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputName3EditPart) {
			((InputName3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(InputName3EditPart.VISUAL_ID));
	}
