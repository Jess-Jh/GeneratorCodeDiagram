...
import uidiagram.diagram.edit.policies.Checkbox5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Checkbox5EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Checkbox5EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Checkbox5ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CheckboxName5EditPart) {
			((CheckboxName5EditPart) childEditPart).setLabel(getPrimaryShape().getFigureCheckboxLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UidiagramVisualIDRegistry.getType(CheckboxName5EditPart.VISUAL_ID));
	}
