...
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartmentCanonicalEditPolicy;
import uidiagram.diagram.edit.policies.ListViewListViewListTemplateWidgetCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ListViewListViewListTemplateWidgetCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public ListViewListViewListTemplateWidgetCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.ListViewListViewListTemplateWidgetCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ListViewListViewListTemplateWidgetCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(UidiagramVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ListViewListViewListTemplateWidgetCompartmentCanonicalEditPolicy());
	}
