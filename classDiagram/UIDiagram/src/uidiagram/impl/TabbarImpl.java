...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tabbar</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uidiagram.impl.TabbarImpl#getListButtons <em>List Buttons</em>}</li>
 *   <li>{@link uidiagram.impl.TabbarImpl#getListLabels <em>List Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TabbarImpl extends TemplateWidgetImpl implements Tabbar {
	/**
	...
	protected EClass eStaticClass() {
		return UidiagramPackage.Literals.TABBAR;
	}
	...
	public EList<Button> getListButtons() {
		if (listButtons == null) {
			listButtons = new EObjectContainmentEList<Button>(Button.class, this, UidiagramPackage.TABBAR__LIST_BUTTONS);
		}
		return listButtons;
	}
	...
	public EList<Label> getListLabels() {
		if (listLabels == null) {
			listLabels = new EObjectContainmentEList<Label>(Label.class, this, UidiagramPackage.TABBAR__LIST_LABELS);
		}
		return listLabels;
	}
